...
namespace ShutdownIfDontUsed.Services;
...
public class ProcessServices : IProcessServices
{
        ...
        IntPtr  environmentBlock)
    {
        ...
        startupInfo.lpDesktop = @"WinSta0\WinLogon"; // Modify as needed.
        //startupInfo.lpDesktop = null; // Modify as needed.
        startupInfo.dwFlags = 0x00000020; //  STARTF_RUNFULLSCREEN; //  STARTF_USESHOWWINDOW; // | STARTF_FORCEONFEEDBACK;
                                                      // https://learn.microsoft.com/en-us/windows/win32/api/processthreadsapi/ns-processthreadsapi-startupinfoa
        startupInfo.wShowWindow = 7; // 10; // 9; // SW_SHOW;
